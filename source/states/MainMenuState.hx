...
{
	public static var psychEngineVersion:String = '2.0 HOTFIX'; // This is also used for Discord RPC
	...
	override function create()
	{
		...
		var psychVer:FlxText = new FlxText(12, FlxG.height - 44, 0, "VS Cyborg v" + psychEngineVersion, 12);
